...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::emergency_resume,
            commands::get_stop_state,
            commands::get_max_deletions,
            commands::set_max_deletions,
            commands::get_pending_deletions,
            commands::resolve_pending_deletions,
